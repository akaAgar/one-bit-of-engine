...
{
    /// <summary>
    /// File source using an One Bit of Engine archive file as a file source
    /// </summary>
    public class FileSourceArchive : FileSource
    {
        ...
        /// Constructor.
        /// </summary>
        /// <param name="path">Path to the One Bit of Engine archive to use as a source file</param>
        ...
        /// <summary>
        /// Creates an One Bit of Engine archive from an array of source files.
        /// </summary>
