...
{
    /// <summary>
    /// Provides access to media files used by One Bit of Engine. Can load files from a variety of sources such as a folder or an encrypted archive.
    /// </summary>
    public sealed class FileSystem
    {
        ...
        /// <summary>
        /// Uses an One Bit of Engine archive as the file source from now on.
        /// </summary>
