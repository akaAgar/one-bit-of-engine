...
namespace OneBitOfEngine.Input
{
    ...
    public sealed class InputManager
    {
        ...
        /// Default is 0.5.
        /// </summary>
        public float GamepadTriggerThreshold { get { return GamepadTriggerThreshold_; } set { GamepadTriggerThreshold_ = OneBitOfTools.Clamp(value, 0.01f, 0.99f); } }
        ...
        /// Default is 0.25.
        /// </summary>
        public float GamepadStickAxisThreshold { get { return GamepadStickAxisThreshold_; } set { GamepadStickAxisThreshold_ = OneBitOfTools.Clamp(value, 0.01f, 0.99f); } }
        private float GamepadStickAxisThreshold_ = 0.25f;

        /// <summary>
        /// (Private) The <see cref="OneBitOfGame"/> this <see cref="=InputManager"/> belongs to.
        /// </summary>
