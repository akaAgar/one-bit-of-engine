...
namespace OneBitOfEngine.OpenGL
{
    ...
    public sealed class TileRenderer
    {
        ...
        /// </summary>
        public int TileAnimationFrames { get { return TileAnimationFrames_; } set { TileAnimationFrames_ = OneBitOfTools.Clamp(value, 1, 3); ResetAnimation(); } }
        ...
        /// </summary>
        public float TileAnimationFrameDuration { get { return TileAnimationFrameDuration_; } set { TileAnimationFrameDuration_ = OneBitOfTools.Clamp(value, .1f, 10.0f); ResetAnimation(); } }
